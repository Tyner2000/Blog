<template>
  <div class="px-4 mx-auto sm:px-6 xl:max-w-5xl xl:px-0 mt-10">
    ...
    <p class="text-center font-bold my-5 text-red-500">
      {{ short.tags }}
    </p>
    <nuxt-content class="prose min-w-full p-10 mx-auto" :document="short" />
  </div>
</template>
...
export default {
  ...
  async asyncData({ $content, params }) {
    const short = await $content("shorts", params.slug).fetch();
    return {
      short: short,
    };
  },
      ...
      meta: [
        {
          hid: "description",
          name: "description",
          content: this.short.description,
        },
      ],
    };
  },
